...
const steps = [
  ...
  },
  {
    ...
    icon: '❤️',
    title: 'Enter Arena',
    description: '1 Life is at stake. Win the challenge to keep it. Lose it only on failure!',
  ...
  },
  {
    ...
    description: 'Predict the next event. Out of lives? Buy more with Fan Tokens.',
    color: '#f59e0b',
  },
  {
    number: '04',
    icon: '🏆',
    title: 'Win Rewards',
    description: 'Earn points to top the rankings and win daily/weekly prizes!',
    color: '#22c55e',
  },
];
